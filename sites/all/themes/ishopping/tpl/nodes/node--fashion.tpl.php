...
<div id="article-<?php print $node->nid; ?>" class="article <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="gallery_formatter" id="slider">
    <?php print render($content['field_cloth_images']); ?>
  </div>

  <div class="summary_text">
  <?php
    if (!empty($content['body']['#object']->body['und'][0]['summary'])) :
      print $content['body']['#object']->body['und'][0]['summary'];
    else :
  ...
  ?>
   ...
   <div class="product_info">
    <?php
      ...
      print render($content['field_size']);
